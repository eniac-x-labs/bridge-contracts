...
contract L2PoolDeployer is Script {
    ...
    function run() external {
        ...
        L2PoolManager(address(proxyL2Pool)).setValidChainId(10, true);  // OP mainnet

        L2PoolManager(address(proxyL2Pool)).setSupportERC20Token(0xf55BEC9cafDbE8730f096Aa55dad6D22d44099Df, true);// usdt
